...
tasks = [
    {"id": "G4-1", "name": "도메인 전문가 롤플레이", "desc": "30개 도메인 전문가 페르소나 기반 전문 상담 대화", "status": "wait",
     ...
     "seeds": [
         {"name": "전문가 페르소나 풀", "category": "D (Synthetic)", "usage": "자체 생성 — 의사, 변호사, 엔지니어 등 20~30개 역할", "contamination": "오염 위험 없음"},
         {"name": "도메인 지식 레퍼런스", "category": "D (Synthetic)", "usage": "공신력 있는 공개 자료를 지식 근거로만 참조", "contamination": "오염 없음"}]},
